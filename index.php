...
<ul class="w3-navbar w3-white w3-large">
  ...
  <li><a href="#about">Listing</a></li>
  <li><a href="#contact">Agent</a></li>
  <li class="w3-right w3-light-grey"><a href="#contact">Login</a></li>
  <li class="w3-right"><a href="#"  class="w3-green">Sell Your House Now!</a></li>
</ul>

<!-- Sidenav/menu -->
<!-- <nav class="w3-sidenav w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidenav"> -->
<div class="w3-row">
<div class="w3-light-grey w3-col m4 l3 " style="z-index:3">
  <div class="w3-container w3-padding-8">
    ...
    <form action="form.asp" target="_blank">
      <p><label><i class="fa fa-search"></i> Keyword</label></p>
...
<div class="w3-main w3-white w3-col m8 l9" >
  ...
  <div class="w3-row-padding w3-section">
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="assets/house-1.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(1)" title="Living room">
    </div>
    <div class="w3-col s3">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      <div class="w3-col s6">
        ...
        <p><i class="fa fa-fw fa-futbol-o"></i> Sport Area</p>
      </div>
      <div class="w3-col s6">
        <p><i class="fa fa-fw fa-cutlery"></i> Kitchen</p>
        <p><i class="fa fa-fw fa-thermometer"></i> Water Heater</p>
        <p><i class="fa fa-fw fa-wheelchair"></i> Accessible</p>
        <p><i class="fa fa-fw fa-lock"></i> Security</p>
      </div>
    </div>
    <hr>
